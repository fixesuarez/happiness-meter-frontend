...
export default function ScoreForm() {
    const [isScoreRequestPending, setIsScoreRequestPending] = useState<boolean>(false)
    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)}>
            <TitleContainer>
                ...
                <Subtitle>Semaine #{dayjs().week()} - du {formatDate(lastMonday)} au {formatDate(lastSunday)}</Subtitle>
            </TitleContainer>
            <InputContainer>
                <label>Note</label>
                <Controller
